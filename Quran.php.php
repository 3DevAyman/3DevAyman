<?php
ob_start();
$API_KEY = "2016785625:AAGwMO_H1ytIPr_Aa9vc-zSKr4JSo5oRLfc"; 
...
$admin = "1939737863" ; //ايديك

if($text ==  '/start' ){
    bot( sendMessage ,[
     chat_id =>$chat_id,
     text => "أهلاً بك في بوت أسلاميات ..
...
هذا البوت من تطوير أيمن الحسين

لا اطلب منك شيئا الا ان تدعو لن بالمغفره .

البوت ليس صدقة جاريه فقط لي انما هو صدقه جاريه لكل ارواح المسلمين .",
'disable_web_page_preview'=> true ,
 'parse_mode'=>"Markdown",
 'reply_markup'=>json_encode([
 'inline_keyboard'=>[
